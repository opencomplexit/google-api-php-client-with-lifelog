...
/**
 * Service definition for Lifelog (v1).
 *
 * <p>
 * Google Fit API</p>
 *
 ...
 * <a href="https://developer.sony.com/develop/services/lifelog-api/" target="_blank">Documentation</a>
 * </p>
 *
 * @author Mikael Johansson
 */
class Google_Service_Lifelog extends Google_Service
{
  ...
  const LIFELOG_PROFILE_READ = "lifelog.profile.read";
  const LIFELOG_ACTIVITY_READ = "lifelog.activities.read";
  const LIFELOG_LOCATION_READ = "lifelog.locations.read";
  ...
  public function __construct(Google_Client $client)
  {
    ...
    $this->rootUrl = 'https://platform.lifelog.sonymobile.com/';
    $this->servicePath = 'v1/users/';
    $this->version = 'v1';
    $this->serviceName = 'fitness'; //Should be changed to lifelog
          ...
          'methods' => array(
            'create' => array(
              ...
              'parameters' => array(
                ...
                'start_time' => array(      /* Added for LifeLog */
                  'location' => 'query',
                  'type' => 'string',
                ),
                'end_time' => array(        /* Added for LifeLog */
                  'location' => 'query',
                  'type' => 'string',
                ),
              ),
...
class Google_Service_Fitness_UsersDataSources_Resource extends Google_Service_Resource
{
  ...
  public function ll_listUsersDataSources($userId, $dataSourceName, $optParams = array())
  {
    $params = array('userId' => $userId, "dataSourceName" => $dataSourceName);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Google_Service_Fitness_ListDataSourcesResponse");
  }
...
{
  protected $collection_key = 'result'; //GAPI: dataSource
  protected $internal_gapi_mappings = array(
  );
