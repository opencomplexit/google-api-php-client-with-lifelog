...
class Google_Auth_OAuth2 extends Google_Auth_Abstract
{
  ...
  private $OAUTH2_REFRESH_TOKEN_URI = 'https://accounts.google.com/o/oauth2/token';
  ...
  {
    $this->client = $client;
    $this->OAUTH2_REVOKE_URI = $this->client->getClassConfig($this, 'auth_revoke_uri');
    $this->OAUTH2_TOKEN_URI = $this->client->getClassConfig($this, 'auth_token_uri'); 
    $this->OAUTH2_AUTH_URL = $this->client->getClassConfig($this, 'auth_auth_uri');
    $this->OAUTH2_REFRESH_TOKEN_URI = $this->client->getClassConfig($this, 'auth_refresh_token_uri');
  }
